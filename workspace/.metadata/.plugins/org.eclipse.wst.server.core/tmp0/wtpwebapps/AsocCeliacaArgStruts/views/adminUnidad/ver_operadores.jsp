...
<div id="page">
	...
	<div id="content">
		...
		<div id="main">
			...
			<tbody>
				...
				<tr>
					...
					<td><s:form theme="simple">
							...
							<s:submit action="opunidad-editar" value="Editar">
								<img src="resources/tema1/images/edit.png" alt="Editar" class="acciones">
							</s:submit><br>
							<s:submit action="opunidad-eliminado" value="Eliminar">
			...
			<s:form theme="simple">
				<s:submit action="registrar_opU" value="Agregar Operador" cssClass="button"/>
			</s:form>
		</div>
	</div>
