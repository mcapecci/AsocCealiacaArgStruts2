...
<body>
	<div id="page">
		...
		<div id="content">
			...
			<div id="main">	
				<h3>Edici&oacute;n de Operador de la Unidad</h3>
				<fieldset align="right">
				<s:form action="opunidad-modificado" theme="simple">
					...
					<s:submit value="Cancelar" action="ver_operadoresU" cssClass="button" />
				</s:form>
				<br>
				(*): Campo Obligatorio
				</fieldset>
