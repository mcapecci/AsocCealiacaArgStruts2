...
<div id="page">
	...
	<div id="content">
		...
		<div id="main">
			...
			<tbody>
				...
				<tr>
					...
					<td><s:form theme="simple">
							...
							<s:submit action="opcentral-editar" value="Editar">
								<img src="resources/tema1/images/edit.png" alt="Editar" class="acciones">
							</s:submit><br>
							<s:submit action="opcentral-eliminado" value="Eliminar">
			...
			<s:form theme="simple">
				<s:submit action="registrar_opC" value="Agregar Operador" cssClass="button"/>
			</s:form>
		</div>
	</div>
