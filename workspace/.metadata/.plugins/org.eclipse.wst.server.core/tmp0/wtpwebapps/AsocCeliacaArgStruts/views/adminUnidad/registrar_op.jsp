	...
	<div id="page">
		...
		<div id="content">
			...
			<div id="main">
				...
				<s:form action="opunidad-registrado" theme="simple">
					<s:label value="Perfil"/><s:textfield name="perfil" value="Operador Unidad" readonly="true" cssClass="readonly"/><br><br>
					<s:label value="Sede"/><s:textfield name="sede" value="%{entidad.nombre}" readonly="true" cssClass="readonly"/><br><br>
