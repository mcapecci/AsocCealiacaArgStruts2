...
/** Este bean realiza las funciones referidas a un Operador Central
 *  desde un usuario con perfil Administrador Central 
 */

@ManagedBean(name="adminOpCentralBean")
@SessionScoped
public class AdminOpCentralBean {
	private long id;
	...
	public Entidad getEntidad() {
		return ((AdministradorCentral)this.getLoginbean().getUser()).getCentral();
	}
	public void setEntidad(Entidad entidad) {
		this.entidad = ((AdministradorCentral)this.getLoginbean().getUser()).getCentral();
	}	
